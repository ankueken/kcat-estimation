...
% 100 to 150 umol photons/m2/s
% 21 gDW/m2
% 4.7619 umol photons/gDW/s
% 4.7619 * 86400 umol photons/gDW/d
% 150 umol photons/m2/s => 7.1429 umol photons/gDW/s

model_irr.lb(strcmp(model_irr.rxns,'Im_hnu')) = 4.7619*86400;
model_irr.ub(strcmp(model_irr.rxns,'Im_hnu')) = 7.1429*86400;

%% gas exchange

% 6 to 6.5 umol/m2/s net CO2 uptake
% 21 gDW/m2
% 0.2857 umol/gDW/s

model_irr.lb(strcmp(model_irr.rxns,'Im_CO2')) = 0.2857*86400;
model_irr.ub(strcmp(model_irr.rxns,'Im_CO2')) = 0.3095*86400;
